...
public class StringCompareTest {
    ...
    @Test
    public void whenShorterStringIsPrefixShouldBeNegative() {
        StringCompare compare = new StringCompare();
        int rst = compare.compare("abc", "abcd");
        assertThat(rst).isLessThan(0);
    }

    @Test
    public void whenLongerStringIsPrefixShouldBePositive() {
        StringCompare compare = new StringCompare();
        int rst = compare.compare("abcd", "abc");
        assertThat(rst).isGreaterThan(0);
    }

    @Test
    public void whenEmptyStringsShouldBeEqual() {
        StringCompare compare = new StringCompare();
